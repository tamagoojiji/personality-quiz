...
const QUIZ_DATA = {
  ...
  mistakes: [
    ...
    {
      type: "trueFalse",
      question: "狼のミスの傾向に「ミスの概念がないことがミス」がある。",
      answer: true,
      explanation: "正解です。狼は自分の流儀を大事にするあまり、そもそもミスの概念がないこと自体がミスになります。"
    },
    {
      type: "trueFalse",
      question: "こじかのミスの傾向に「予算の見積もりと管理が甘くてミス」がある。",
      answer: true,
      explanation: "正解です。こじかは駆け引きや計算が苦手で、予算の見積もりと管理が甘くなりがちです。"
    },
    {
      type: "trueFalse",
      question: "猿のミスの傾向に「長期戦でミス」がある。",
      answer: true,
      explanation: "正解です。猿は「短期で体力と集中がもたないミス」があり、長期戦が苦手です。"
    },
    {
      type: "trueFalse",
    ...
    {
      type: "trueFalse",
      question: "コアラのミスの傾向に「派閥をつくってミス」がある。",
      answer: true,
      explanation: "正解です。コアラはナワバリ意識が強く派閥を作りがちで、それがミスにつながることがあります。"
    },
  ]
};
